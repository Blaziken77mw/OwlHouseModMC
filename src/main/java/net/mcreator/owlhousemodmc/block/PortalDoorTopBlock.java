...
import net.mcreator.owlhousemodmc.procedures.PortalDoorTopOnBlockRightClickedProcedure;
...
public class PortalDoorTopBlock extends OwlhousemodmcModElements.ModElement {
	@ObjectHolder("owlhousemodmc:portal_door_top")
	public static final Block block = null;
	public PortalDoorTopBlock(OwlhousemodmcModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 10f).setLightLevel(s -> 6).harvestLevel(1)
			...
			setRegistryName("portal_door_top");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PortalDoorTopOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
