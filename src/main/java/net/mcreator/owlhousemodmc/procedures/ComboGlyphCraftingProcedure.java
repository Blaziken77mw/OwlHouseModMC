	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				OwlhousemodmcMod.LOGGER.warn("Failed to load dependency entity for procedure ComboGlyphCrafting!");
			return;
		}
		...
		if (new Object() {
			...
			if (entity instanceof PlayerEntity) {
				...
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						ItemStack _setstack = new ItemStack(ComboGlyphItem.block);
			...
			if ((new Object() {
				...
				}.getItemStack((int) (0))).getOrCreateTag().putString("primary", "fire");
			}
		} else {
			if (entity instanceof ServerPlayerEntity) {
				Container _current = ((ServerPlayerEntity) entity).openContainer;
