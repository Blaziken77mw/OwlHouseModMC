		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6750004).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-6750004).withFoliageColor(-3191243).withGrassColor(-3201241)
				...
				event.getRegistry().register(biome.setRegistryName("owlhousemodmc:plainsboilingisles_2"));
			}
		}
	}
