 ...
 *
 *    Keep the OwlhousemodmcModElements object in this class and all calls to this object
...
@Mod("owlhousemodmc")
public class OwlhousemodmcMod {
	public static final Logger LOGGER = LogManager.getLogger(OwlhousemodmcMod.class);
	...
	public OwlhousemodmcMod() {
		...
		MinecraftForge.EVENT_BUS.register(new OwlhousemodmcModFMLBusEvents(this));
	}
