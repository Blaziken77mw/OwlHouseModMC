...
import net.mcreator.owlhousemodmc.procedures.FireGlyphProjectileBulletHitsLivingEntityProcedure;
...
public class FireGlyphProjectileItem extends OwlhousemodmcModElements.ModElement {
	@ObjectHolder("owlhousemodmc:fire_glyph_projectile")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("fire_glyph_projectile");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 3, 2);
