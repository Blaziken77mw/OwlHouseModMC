...
public class RavenstaffItem extends OwlhousemodmcModElements.ModElement {
	@ObjectHolder("owlhousemodmc:ravenstaff")
	public static final Item block = null;
	public RavenstaffItem(OwlhousemodmcModElements instance) {
		super(instance, 103);
	}
