...
import net.mcreator.owlhousemodmc.procedures.GlyphUnlockRightClickedInAirProcedure;
...
public class GlyphUnlockItem extends OwlhousemodmcModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Creative only"));
		}
