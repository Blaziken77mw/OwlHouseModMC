...
import net.mcreator.owlhousemodmc.gui.NotepadGuiGuiWindow;
import net.mcreator.owlhousemodmc.gui.NotepadGuiGui;
...
public class NotepadItem extends OwlhousemodmcModElements.ModElement {
	@ObjectHolder("owlhousemodmc:notepad")
	public static final Item block = null;

	public NotepadItem(OwlhousemodmcModElements instance) {
		super(instance, 25);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof NotepadGuiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Notepad");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new NotepadGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
